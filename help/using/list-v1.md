...
>
>Para obtener más información sobre la versión actual del componente de lista, consulte el documento Componente [de](list.md) lista.
...
Independientemente de cómo se cree la lista, hay opciones [de](list-v1.md#main-pars_title_1568376452) ordenación que siempre se pueden configurar.
...
* **Elementos** de vínculo: opción Activar elementos de vínculo en el cuadro de diálogo [Editar](list-v1.md#main-pars_title_550499279)
* **Mostrar descripciones** : activar la opción Mostrar descripciones en el cuadro de diálogo [Editar](list-v1.md#main-pars_title_550499279)
* **Mostrar fecha** : opción Activar la opción Mostrar fecha en el cuadro de diálogo [Editar](list-v1.md#main-pars_title_550499279)
