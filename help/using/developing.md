...
#### AEM como servicio de nube {#aem-cloud-service}
...
>[!NOTE]
>
>En los entornos de producción locales, ejecute siempre Quickstart en `nosamplecontent` modo de ejecución. Para utilizar los componentes principales en `nosamplecontent` modo de ejecución, siga las instrucciones de la página de documentación [Uso de componentes](using.md) principales.
