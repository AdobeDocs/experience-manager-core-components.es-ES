...
|-----|---|---|
| Implementación de lógica | Pojos Java con [anotaciones Sling Modelos](https://sling.apache.org/documentation/bundles/models.html) | Código JSP |
...
Para obtener una descripción general de la próxima hoja de ruta Principal, vea el [proyecto wiki en github](https://github.com/adobe/aem-core-wcm-components/wiki/home).
