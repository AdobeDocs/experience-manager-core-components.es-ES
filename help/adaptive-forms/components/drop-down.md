...
La pestaña se utiliza para definir y administrar los estilos CSS de un componente. La lista desplegable Forms adaptable Componente principal es compatible con el AEM [Sistema de estilos](/help/get-started/authoring.md#component-styling).
