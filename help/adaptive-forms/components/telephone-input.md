...
La pestaña se utiliza para definir y administrar los estilos CSS de un componente. El componente principal de entrada del teléfono de Forms adaptable admite la AEM [Sistema de estilos](/help/get-started/authoring.md#component-styling).
