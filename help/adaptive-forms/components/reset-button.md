...
La pestaña se utiliza para definir y administrar los estilos CSS de un componente. El botón Forms adaptable Restablecer componente principal es compatible con el AEM [Sistema de estilos](/help/get-started/authoring.md#component-styling).
