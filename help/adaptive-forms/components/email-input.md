...
<br>
    ...
    - **Mensaje de error**: esta opción le permite introducir un mensaje que se muestra en la pantalla si el ID de correo electrónico no se valida con el valor introducido en la opción **Patrón**
