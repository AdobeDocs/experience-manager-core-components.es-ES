...
# Temáticas de muestra, plantillas y modelos de datos de formulario {#sample-themes-templates-and-data-models}
...
El **de serie** [Componentes principales de formularios adaptables](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/introduction.html?lang=es) los temas son:
...
![Tema de lienzo](/help/adaptive-forms/assets/Safety-Inspection-Theme-Canvas.png)
...
![Tema de caballete](/help/adaptive-forms/assets/Safety-Inspection-Theme-Easel.png)
...
El **de serie** [Componentes principales de formularios adaptables](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/introduction.html?lang=es) Las plantillas son:
...
![Plantilla para dar comentarios](/help/adaptive-forms/assets/Give-feedback-desktop-view.png)
...
![Resumen de beneficios de empleados](/help/adaptive-forms/assets/Employee-benefits-summary.png)
