...
>[!NOTE]
>
>Se recomienda actualizar el proyecto Maven para que haga referencia a la última versión del complemento que se encuentra en el [repositorio central de Maven.](https://repo1.maven.org/maven2/com/adobe/aem/aemanalyser-maven-plugin/)
...
| `bundle-unversioned-packages` | Comprueba si los paquetes OSGi especifican una versión con una declaración exportar-empaquetar y un intervalo de versiones con una declaración importar-empaquetar. Un error tendría este aspecto: <p> </p> `[ERROR] org.acme:mybundle:0.0.1-SNAPSHOT: Bundle org.acme:mybundle:0.0.1-SNAPSHOT is exporting package org.acme.foo without a version.`<p> </p>Para solucionar problemas, asegúrese de agregar `package-info.java` a ese paquete especificando la versión que desea exportar. | Sí | Sí |
...
| `aem-provider-type` | Comprueba si el código de la aplicación implementa o amplía una interfaz o clase &quot;ProviderType&quot; desde la interfaz o clase (el producto); consulte [CQBP-84](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/how-to-use/custom-code-quality-rules.html?lang=es#product-apis-annotated-with-providertype-should-not-be-implemented-or-extended-by-customers) | Sí | Sí |
| `configurations-basic` | Comprueba las configuraciones de OSGi para detectar errores comunes, como no especificar el tipo correcto para la propiedad &quot;service.ranking&quot;. | Sí | Sí |
