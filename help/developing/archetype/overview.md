...
| `groupId` |  | ID del grupo base de Maven (p. ej. `"com.mysite"`). Este valor debe ser [nombre de paquete Java válido.](https://docs.oracle.com/javase/specs/jls/se6/html/packages.html#7.7) |
