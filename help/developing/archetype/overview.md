...
| `sdkFormsVersion` | `latest` | When `aemVersion=cloud` y uno de `includeFormsenrollment=y` o `includeFormscommunications=y`, se puede especificar una versión del SDK de Forms (p. ej. `2020.12.17.02`). |
...
| `includeFormsheadless` | `n` | Incluye [Componentes principales de Forms](https://github.com/adobe/aem-core-forms-components) dependencias, `ui.frontend.react.forms.af`, y artefactos sin encabezado. |

## Requisitos del sistema {#requirements}

| Tipo de archivo | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [39](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-39) | Continua | 6.5.7.0+ | 8, 11 | 3.3.9+ |
