...
| `includeFormscommunications` | `n` | Incluye [Componentes principales de Forms](https://github.com/adobe/aem-core-forms-components) dependencias, plantillas, modelos de datos de formulario, temas y genera los artefactos correspondientes para los programas de Forms Communications. |
| `includeFormsenrollment` | `n` | Incluye [Componentes principales de Forms](https://github.com/adobe/aem-core-forms-components) dependencias, plantillas, modelos de datos de formulario, temas y genera los artefactos correspondientes para los programas de inscripción de Forms. |

## Requisitos del sistema {#requirements}

| Tipo de archivo | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [32](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-32) | Continua | 6.5.7.0+ | 8, 11 | 3.3.9+ |
