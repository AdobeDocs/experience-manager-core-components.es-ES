...
user-guide-description: Para los proyectos tradicionales de AEM, utilice los componentes principales ampliables para que los autores puedan crear contenido fácilmente.
