...
>
>Los componentes de pestaña simples (no anidados) se pueden localizar o seleccionar mediante el [árbol de contenido](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/environment-tools.html#content-tree); sin embargo, las pestañas anidadas no.

## Vinculación profunda a un panel {#deep-linking}

Las pestañas y los [componentes de acordeón](accordion.md) admiten la vinculación directa a un panel dentro del componente.
