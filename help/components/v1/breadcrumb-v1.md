...
Este documento describe la versión 1 del componente de ruta de navegación, que se introdujo originalmente con la versión 1.0.0 de los componentes principales con AEM 6.3.

La siguiente tabla lista la compatibilidad de v1 del componente de ruta de navegación.
...
>[!CAUTION]
>
>Este documento describe la versión 1 del componente de ruta de navegación.
>Para obtener más información sobre la versión actual del componente de ruta de navegación, consulte el documento [Componente de ruta de navegación](/help/components/breadcrumb.md).
...
* **Navegación de nivel a inicio** : en la jerarquía, el componente de ruta de exploración debe tener el inicio de bajar a la página actual. Por ejemplo en We.Retail:

   * 1 inicios a `/content/we-retail`
   * 2 inicios a `/content/we-retail/<country>`
...
* **Navigation-Level to inicio** - Define el valor predeterminado para dónde en la jerarquía el componente de ruta de exploración debe tener inicios para ir a la página actual cuando se agrega el componente de ruta de exploración a una página.
...
* **Ocultar actual** : define el valor predeterminado de la opción  **Ocultar** corriente cuando se agrega el componente de ruta de exploración a una página.

   * No activa ni desactiva la opción para el autor. Solo establece el valor predeterminado.

## Detalles técnicos {#technical-details}

La documentación técnica más reciente sobre el componente de ruta de navegación [se encuentra en GitHub](https://github.com/adobe/aem-core-wcm-components/tree/master/content/src/content/jcr_root/apps/core/wcm/components/breadcrumb/v1/breadcrumb).
