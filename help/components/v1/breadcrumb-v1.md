...
>Para obtener más información sobre la versión actual del componente de ruta de navegación, consulte el documento [Componente](/help/components/breadcrumb.md) de ruta de navegación.
