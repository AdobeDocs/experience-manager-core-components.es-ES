...
|  |  |
|---|---|
| Listo para la producción | Los componentes principales son 30 componentes de WCM robustos, bien probados, ampliamente utilizados y con un buen rendimiento. |
...
* [Contenedor de formulario](components/forms/form-container.md)
...
|---|---|---|---|---|---|
| [2.30.4](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.30.4) | Continua | 6.5 LTS GA | 6.5.21.0+ | 8, 11, 17, 21 | 3.3.9+ |
...
* [Componentes principales de formularios adaptables](/help/adaptive-forms/introduction.md): mediante los componentes principales de formularios adaptables de Adobe Experience Manager, puede crear experiencias de inscripción atractivas.
